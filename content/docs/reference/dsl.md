...
- <a href="#resequence">resequence (reseq)</a>
...
### random
<a name="random"></a>
Create a random integer generator. Use next() to genera  te a new integer.
...
##### generated by dsl-md.go on Mar 29, 2026
